...
\subsection{Node.js}
Node.js is a Javascript runtime, which brings Javascript to the server environment. It uses an event-driven and non-blocking I/O model for maximum efficiency, while remaining lightweight. This makes node.js the ideal technology to implement the server side of the trckr frontend application. 
