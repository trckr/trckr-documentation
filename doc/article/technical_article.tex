...
\begin{abstract}
  ...
  functionalities of the web-based application trckr. The audience for trckr 
  % Since we want trckr to be all lowercase, we avoid using it at the start of
  % the sentence
  are people who work on a project and need an intuitive and simple web tool to
...
This means that the complete back-end environment can be setup inside multiple
docker containers that can be run locally as well as on any server.
...
it provides to inexpierienced developers. The features of Vue.js allow
