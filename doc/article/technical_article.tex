...
\begin{abstract}
  ...
  Both technologies were new to most team members, but all membershave proven
  themselves
  %effective
  self driven and learning these skills was ultimately a benefit to the
...
%The most important requirement is to require just a few steps to track all the
%required information.
...
it provides unexperienced developers. The features that Vue.js provides allow
...
seperation of concerns as illustrated in figure \ref{fig:architecture}, using
Django with PostgreSQL in the backend and a frontend based around Vue.js.

%TODO: baliddim: I don't think we can write figure instead of Figure. -> by
%design
%TODO: Front-End and Back-End in figure 1.
